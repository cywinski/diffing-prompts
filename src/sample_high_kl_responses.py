# ABOUTME: Sample multiple LLM responses for high KL divergence tokens from extracted JSON files.
# ABOUTME: Skips infinite KL values and saves each entry's responses to separate JSON files in parallel.
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="Sample LLM responses for high KL divergence tokens"
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    print(f"KL threshold: {high_kl_data['kl_threshold']}")
